export const FLASHCARDS = [
  // ── Chapter 8: Sources of Capital ─────────────────────────────────────────
  {
    ...
    front: 'What is Bootstrapping and what are its 5 strategic approaches?',
    back: 'Founding/building a venture from personal finances or operating revenue.\n5 approaches:\n1. Delaying payments\n2. Private-owner financed\n3. Minimizing\n4. Relationship oriented\n5. Subsidy oriented\nExamples: Apple, Dell, Meta, Microsoft, eBay',
  },
  {
    ch: 8, topic: 'Bootstrapping',
  ...
  },
  {
    ...
    front: 'Advantages and Disadvantages of Debt Financing',
    back: 'Advantages:\n• No ownership relinquishment\n• Greater return on equity potential\n• Low interest rates reduce borrowing cost\n\nDisadvantages:\n• Monthly interest payments required\n• Cash-flow strain from repayment obligations\n• Heavy debt inhibits growth and development',
  },
  {
    ch: 8, topic: 'Debt Financing',
  ...
  },
  {
    ...
    front: 'What is a Private Placement? Key regulations?',
    back: 'Selling securities directly to a small group of accredited investors without full SEC registration.\n• Governed by Regulation D exemptions: Rule 504, 505, 506\n• Faster and cheaper than a public offering\n• Investors must be accredited (net worth >$1M or income >$200K)\n• No general solicitation allowed under most Reg D rules',
  },
  {
  ...
  },
  {
    ...
    front: 'What do Venture Capitalists look for in a venture?',
    back: '• Strong, experienced management team (most important)\n• Large addressable market (usually $100M+)\n• Unique/proprietary product or service\n• Scalable business model\n• Clear exit strategy (IPO or acquisition)\n• Expected 5–10x return in 5–7 years\n• VC investment dropped dramatically in 2023',
  },
  {
    ch: 8, topic: 'Venture Capital',
    front: 'VC Return Expectations by Stage (Table 8.2)',
    back: 'Seed stage: 50–100%+ ROI expected\nFirst stage: 40–60%\nSecond stage: 30–50%\nThird/Expansion stage: 25–40%\nBridge/IPO stage: 20–30%\n\nHigher risk = higher expected return. VC firms typically look for 5-10x total return.',
  },
  {
  ...
  },
  {
    ...
    front: 'Trademarks vs Trade Secrets',
    back: 'Trademark: protects brand names, logos, slogans; registered with USPTO (Principal Register); indefinite protection with continued use; Federal Trademark Dilution Act (1995) + Dilution Revision Act protect famous marks from dilution.\n\nTrade Secret: confidential business info (formulas, processes, client lists); no registration; protected through NDAs and internal controls; must actively maintain secrecy. Example: Coca-Cola formula.',
  },
  {
  ...
  // ── Chapter 10: Marketing Challenges ──────────────────────────────────────
  {
    ...
    front: 'Entrepreneurial Marketing vs Conventional Marketing (Table 10.3)',
    back: 'Conventional Marketing:\n• Large budgets, formal market research\n• Mass marketing, established channels\n• Focus on market share\n\nEntrepreneurial Marketing:\n• Resource-constrained, opportunity-driven\n• Customer intimacy and direct contact\n• Guerrilla tactics, word-of-mouth\n• Interactive and iterative\n• Relies on creativity over capital',
  },
  {
    ch: 10, topic: 'Entrepreneurial Marketing',
  ...
  },
  {
    ...
    front: 'Product Life Cycle Pricing (Table 10.5)',
    back: 'Introduction: Skimming (high price, recover R&D) OR Penetration (low price, gain share)\nGrowth: Competitive pricing to maintain/expand share\nMaturity: Competitive + promotional pricing (price wars common)\nDecline: Reduce prices to clear inventory; consider discontinuation\n\nPricing views: value, variable, variety, visible, virtuous. Social media age adds dynamic and referral pricing.',
  },
  {
  ...
  },
  {
    ...
    front: 'Who reads a business plan and what do they look for?',
    back: 'Entrepreneurs: roadmap, forces systematic thinking, identifies gaps before launch\n\nInvestors/Lenders:\n• Market detail and size\n• Funding requirements and use of funds\n• Management team quality\n• Financial projections and exit strategy\n\nManagement Team: alignment on strategy and milestones\n\nPartners/Suppliers: assess viability and credibility',
  },
  {
  ...
  },
  {
    ...
    front: 'Operations Segment vs Management Segment',
    back: 'Operations Segment covers:\n• Location and facilities\n• Production process and technology\n• Supply chain and vendors\n• Quality control procedures\n• Regulatory compliance\n• Capacity planning and scalability\n\nManagement Segment covers:\n• Key personnel bios and relevant experience\n• Organizational chart\n• Advisory board and board of directors\n• Identification of team gaps and how they will be filled\n• Why THIS team can execute the plan',
  },
  {
